...
// Custom comment counter

if( ! function_exists( 'comment_counter ' )){

	function comment_counter() {
		if( comments_open() || get_comments_number() ) {
			echo '<span class="comments-link">';
				comments_popup_link( esc_html__( 'No comment', 'understrap' ), esc_html__( '1 comment', 'understrap' ), esc_html__( '% comments', 'understrap' ) );
			echo '</span>';
		}
